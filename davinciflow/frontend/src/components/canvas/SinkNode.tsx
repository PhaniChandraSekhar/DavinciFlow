  ...
  return (
    <div
      className={cn(
        ...
        selected && 'border-brand-sink ring-2 ring-brand-sink/30'
      )}
    >
      <Handle
        type="target"
        position={Position.Top}
        className="!border-brand-sink/70 !bg-slate-950"
      />

      <div className="mb-4 flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-brand-sink/30 bg-brand-sink/15 text-brand-sink">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 text-[11px] uppercase tracking-[0.24em] text-slate-500">Sink</div>
          </div>
        </div>
        <div
          className={cn(
