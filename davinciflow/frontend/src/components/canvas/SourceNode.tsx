  ...
  return (
    <div
      className={cn(
        ...
        selected && 'border-brand.source ring-2 ring-brand.source/30'
      )}
    >
      <div className="mb-4 flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-2xl border border-brand.source/30 bg-brand.source/15 text-brand.source">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-1 text-[11px] uppercase tracking-[0.24em] text-slate-500">Source Step</div>
          </div>
        </div>
        <div
          className={cn(
      ...
      <Handle
        ...
        className="!border-brand.source/70 !bg-slate-950"
      />
    </div>
  );
}
